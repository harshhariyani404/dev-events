        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={3}
              className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 focus:border-green-200 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            file:bg-green-200 file:px-4 file:py-2
